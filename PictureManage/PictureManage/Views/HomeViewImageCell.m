        ...
        for(int i = 0 ;i<3;i++)
        {
            if(i == 0){
                if(startIndex <pictuesCount){
                    UIImage *newImageLeft = [UIImage imageWithContentsOfFile:[[self.puctures objectAtIndex:startIndex]imageThumbnailUrl]] ;                  
                    [leftImageView.imageView setImage:newImageLeft];
                ...
                if(startIndex +1 < pictuesCount){
                    ...
                    UIImage *imageCompressMiddle = [UIImage imageWithContentsOfFile:[[self.puctures objectAtIndex:startIndex+1]imageThumbnailUrl] ];
                    [middleImageView.imageView setImage:imageCompressMiddle];
                ...
                if(startIndex +2 < pictuesCount){
                    ...
                    UIImage *imageCompressRight = [UIImage imageWithContentsOfFile:[[self.puctures objectAtIndex:startIndex+2]imageThumbnailUrl]];
                    [rightImageView.imageView setImage:imageCompressRight];
